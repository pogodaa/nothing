...
def prepare_fresh(regenerate_sql: bool = True) -> None:
    """Удаляет velodrive.db и пользовательские фото; при следующем запуске — импорт из import/."""
    ...
    if config.DB_PATH.exists():
        try:
            ...
            print(
                ...
                "и снова выполните: python3 other/prepare_fresh.py"
            )
    ...
    if not config.IMPORT_DIR.exists():
        raise FileNotFoundError(
            ...
            "Скопируйте import из материалов задания в desktop_linux/import"
        )
    ...
    print()
    print("Готово. Первый запуск: python3 main.py")
